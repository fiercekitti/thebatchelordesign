...
<head>
    ...
    <title>KC Southern Enrollment</title>
...
s1.async=true;
s1.src='https://embed.tawk.to/56f04ace27dba83622c97abe/default';
s1.charset='UTF-8';
...
<body>
         <?php
        	...
        	$from = 'KCS Enrollment Form'; 
        	$to = 'sfsupplierpayments@gmail.com'; 
        	$subject = 'KCS Enrollment Form';
		...
		if (!$errCompanyName && !$errContactName && !$errEmail && !$errPhone) {
        	...
        	$qfrom = 'KCS Supplier Question'; 
        	$qto = 'sfsupplierpayments@gmail.com'; 
        	$qsubject = 'KCS Supplier Question';
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="background-color:white;">
            <div class="container">
                <ul class="nav navbar-nav offset1">
      	            <li><img src="img/hero1_en.jpg" /></li>
                </ul>
            </div>
	</nav>
    </div>
   	...
   	<div class="pageContent">
		...
		<div class="sectionTwo">
			<div class="container">
				<div class="span5 pageBox">
				    <form class="form-horizontal" name="enroll" role="form" method="post" action="KCS_Enroll.php">
				...
				<div class="span5 pageBox">
					...
					<p>Once enrollment is complete, your next payment from KCS will be delivered via Store Financial's secure payment network to the AR/billing email address, plus you'll be granted access to our new accounts virtual card payment portal.</p>
				</div>
		...
		<div class="sectionOne">
			<div class="container">
				...
				<div class="span5 pageBox">
				    <form class="form-horizontal" role="form" name="question" method="post" action="KCS_Enroll.php">
    					<div class="control-group">
