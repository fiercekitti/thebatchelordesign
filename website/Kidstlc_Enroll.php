...
<head>
    ...
    <title>Kidstlc Enrollment</title>
...
<script>
  ...
  ga('send', 'pageview');
    ...
    <style>
    	body {background-color:ghostwhite;color:black;font-family:Gotham;font-size:12px;}
...
<body>
         <?php
        	...
        	$from = 'KidsTLC Enrollment Form'; 
        	$to = 'sfsupplierpayments@gmail.com'; 
        	$subject = 'KidsTLC Enrollment Form';
		...
		if (!$errCompanyName && !$errContactName && !$errEmail && !$errPhone) {
        	...
        	$qfrom = 'KidsTLC Supplier Question'; 
        	$qto = 'sfsupplierpayments@gmail.com'; 
        	$qsubject = 'KidsTLC Supplier Question';
    ...
    <div class="hidden-phone visible-tablet visible-desktop">
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="background-color:#3e8d34;">
            <div class="container">
                <ul class="nav navbar-nav offset1" style="background-color:#3e8d34;">
      	            <li><img src="img/hero_kidstlc.png" /></li>
                </ul>
            </div>
	</nav>
    </div>
   	...
   	<div class="pageContent">
		...
		<div class="sectionTwo">
			<div class="container">
				<div class="span5 pageBox">
				    <form class="form-horizontal" name="enroll" role="form" method="post" action="Kidstlc_Enroll.php">
				...
				<div class="span5 pageBox">
					...
					<p>Once enrollment is complete, your next payment from KidsTLC will be delivered via Store Financial's secure payment network to the AR/billing email address, plus you'll be granted access to our new accounts virtual card payment portal.</p>
				</div>
		...
		<div class="sectionOne">
			<div class="container">
				...
				<div class="span5 pageBox">
				    <form class="form-horizontal" role="form" name="question" method="post" action="Kidstlc_Enroll.php">
    					<div class="control-group">
