...
<head>
    ...
    <title>WOW! Enrollment</title>
    <meta name='description' content='WOW! Supplier Enrollment.' />
    <meta name='keywords' content='electronic cards, electronic payments, virtual cards, supplier paymetns' />
...
<body>
         <?php
        	...
        	$from = 'WOW Enrollment Form'; 
        	$to = 'sfsupplierpayments@gmail.com'; 
        	$subject = 'WOW Enrollment Form';
		...
		if (!$errCompanyName && !$errContactName && !$errEmail && !$errPhone) {
        	...
        	$qfrom = 'WOW Supplier Question'; 
        	$qto = 'sfsupplierpayments@gmail.com'; 
        	$qsubject = 'WOW Supplier Question';
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="background-color:white;">
            <div class="container">
                <ul class="nav navbar-nav offset1">
      	            <li><img src="img/hero1_en-wow.jpg" /></li>
                </ul>
            </div>
	</nav>
    </div>
   	...
   	<div class="pageContent">
		<div class="sectionOne">
			<div class="container">	
				<div class="span10 pageBox" style="margin-top:25px;">
					<p>Thank you for your interest in virtual card payments. In addition to faster and more secure payments, you will have complimentary 24/7 access to our virtual card payment portal with visibility to invoices and payment status. Once you activate your account with Store Financial you will begin receiving your e-payments.</p>
				</div>
		...
		<div class="sectionTwo">
			<div class="container">
				<div class="span5 pageBox">
				    <form class="form-horizontal" name="enroll" role="form" method="post" action="WOW_Enroll.php">
    					...
    					<div class="control-group">
  					    ...
  					    <input type="checkbox" name="employee" id="employee" value="" required>
  					    	I certify that I am an employee of the company for which I am activating an account and have the authority to enroll in the payment program.
					    </label>
					</div>
    					<div class="control-group">
				...
				<div class="span5 pageBox">
					...
					<p>Once enrollment is complete, your next payment from WOW! will be delivered via Store Financial's secure payment network to the AR/billing email address, plus you'll be granted access to our virtual card payment portal.</p>
				</div>
		...
		<div class="sectionOne">
			<div class="container">
				...
				<div class="span5 pageBox">
				    <form class="form-horizontal" role="form" name="question" method="post" action="WOW_Enroll.php">
    					<div class="control-group">
		...
		<div class="sectionTwo">
			<div class="container">
				<div class="span10 pageBox">
					...
					<p>After submitting, a representative from our partner, Store Financial, will call the AR/billing contact you listed within 48 hours to complete the enrollment process.</p>
					<p>This personal touch ensures you get all your questions answered, and verifies we have all the correct information needed to process and send payments.</p>
					<p>Once enrollment is complete, your next payment from WOW! will be delivered via Store Financial's secure payment network to the AR/billing email address, plus you'll be granted access to our new accounts virtual card payment portal.</p>
				</div>
			</div>
		</div>
		<div class="sectionTwo">
