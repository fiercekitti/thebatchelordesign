<?php $page_title = "GMB Mockup - Details"; ?>
...
<div class="card-wells" style="margin-bottom: 40px">
        ...
        <div class="span4 pull-left no-print">
...
<div class="well well-small">
	...
	<a href="#"><input type="submit" value="Register your card" class="btn btn-primary"/</a><br><br>
	<a href="Hyla.pdf"><input type="submit" value="Print or View Card" class="btn btn-primary"/</a>
	</p>
					...
					<strong>
						<div class="row">
							...
							<div class="card-toggled span4 half" id="masked-card">
								**** **** **** 0910   <a class="card-mask-toggler card-toggled" href="#">Show</a>
						...
						<div class="row">
							...
							<div class="span2 half">$50.00</div>
						</div>
						<div class="row">
	...
	<div class="row">
	 ...
	 <div class="row">
            ...
            <div class="row">
                <div class="span7">
                    <div class="">
						<small>This virtual card account is issued by MetaBank®, Member FDIC, pursuant to license by MasterCard® International. </small>
                    </div>
                </div>
            </div>				
        </div>
