<footer>
    	<p style="padding:15px;">©2016 Alcon. All rights reserved.</p>
...
<div id="cardLookupModal" class="modal hide fade">
	...
	<div class="modal-body">
		<p class="lead" style="margin-bottom: 30px">Your virtual card has a unique 16-digit number and a 6-digit security code. Enter the numbers below to check your balance.</p>
		<div class="form-horizontal">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<div class="help-block">6-digit number secuity code.</div>
	...
	<div class="modal-footer">
		...
		<button id="btnCancelCardLookup" class="btn btn-primary" data-dismiss="modal" aria-hidden="true">Cancel</button>
	</div>
</div>
</div>
</body>
