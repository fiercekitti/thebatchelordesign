...
<!--[if gt IE 8]> <html class="no-js" lang="en"> <![endif]--><head>
    ...
    <title>Ivanhoe Cambridge Get My Balance</title>
    <meta name='description' content='Ivanhoe Cambridge Get My Balance Inquiry site. Where you can check your balance at any time.' />
...
<div class="container">  
    ...
    <div class="nav nav-fixed-top">
    	<a href="http://www.ivanhoecambridge.com/en" target="_blank"><img src="http://www.ivanhoecambridge.com/website/content/images/global/logo.svg" style="width:166px; float:left; margin-left:25px;"/></a>
	    ...
	    <ul>
            ...
            <li class="pull-right" style="margin-right:5px;"><a href="login.php"><input type="submit" value="Login" class="btn btn-primary"/></a></li>
