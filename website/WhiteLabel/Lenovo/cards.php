        ...
        <div class="cards-container">
		    <h4 style="color:#ececec;">My Cards</h4>
          	<table class="table table-bordered table-striped" id="cardsTable">
				...
				<tbody>
                    <tr>
                        <td class="hidden-phone"><span><img src="img/giftcard1.png" class="cardFix img-responsive" /></span></td>
	                    <td>**** **** **** 0122</td>
						<td>$50.00</td>
                        <td>
                            <div class="btn-group">
                    ...
                    <tr>
                        <td class="hidden-phone"><span><img src="img/giftcard2.png" class="cardFix img-responsive" /></span></td>
	                    <td>**** **** **** 0122</td>
						<td>$50.00</td>
                        <td>
                            <div class="btn-group">
                    ...
                    <tr>
                        <td class="hidden-phone"><span><img src="img/giftcard3.png" class="cardFix img-responsive" /></span></td>
	                    <td>**** **** **** 0122</td>
						<td>$50.00</td>
                        <td>
                            <div class="btn-group">
                    ...
                    <tr>
                        <td class="hidden-phone"><span><img src="img/giftcard4.png" class="cardFix img-responsive" /></span></td>
	                    <td>**** **** **** 0122</td>
						<td>$50.00</td>
                        <td>
                            <div class="btn-group">
