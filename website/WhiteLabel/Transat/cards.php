<?php $page_title = "Transat Mockup - My Cards"; ?>
...
<?php include("includes/header.php"); ?>
	...
	<div class="span11" style="padding-top:25px; padding-bottom:45px;">
        ...
        <div class="cards-container">
		    <h4 style="color:#ececec;">My Cards</h4>
          	<table class="table table-bordered table-striped" id="cardsTable">
				...
				<tbody>
                    <tr>
                        <td class="hidden-phone"><span><img src="img/clubVoyage.png" class="cardFix img-responsive" /></span></td>
	                    <td>**** **** **** 0122</td>
						<td>$50.00</td>
                        <td>
                            <div class="btn-group">
                    ...
                    <tr>
                        <td class="hidden-phone"><span><img src="img/marlinTravel.png" class="cardFix img-responsive" /></span></td>
	                    <td>**** **** **** 0122</td>
						<td>$50.00</td>
                        <td>
                            <div class="btn-group">
                    ...
                    <tr>
                        <td class="hidden-phone"><span><img src="img/transatTravel.png" class="cardFix img-responsive" /></span></td>
	                    <td>**** **** **** 0122</td>
						<td>$50.00</td>
                        <td>
                            <div class="btn-group">
                    ...
                    <tr>
                        <td class="hidden-phone"><span><img src="img/transatVoyages.png" class="cardFix img-responsive" /></span></td>
	                    <td>**** **** **** 0122</td>
						<td>$50.00</td>
                        <td>
                            <div class="btn-group">
