...
<!--[if gt IE 8]> <html class="no-js" lang="en"> <![endif]--><head>
    ...
    <title>Transat GMB Mockup</title>
...
<div class="container">  
	<header>
		...
		<div class="pull-right" style="margin-top:5px;">
        	    ...
        	    <ul style="display:inline-flex; list-style:none;">
        	     <li><div class="btn-group"><a class="btn btn-link dropdown-toggle" data-toggle="dropdown" href="#">
                                    Language
            	     ...
            	     <li><a data-toggle="modal" href="#cardLookupModal" class="btn btn-link">Check Balance</a></li>
    ...
    <div class="nav nav-fixed-top">
    	<img src="img/longLogo.jpg" style="width:930px; float:left; margin-left:5px;" alt="Logo"/>
	    ...
	    <ul>
            ...
            <li><a href="promo.php"><i class="fa fa-gift fa-1x"></i> Promo Card</a></li>
